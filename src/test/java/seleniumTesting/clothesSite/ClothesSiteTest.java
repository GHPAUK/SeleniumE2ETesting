...
//      driver.quit();
  ...
  @Test
  void navigateToCasualDressesAndAddOneToBasket() throws InterruptedException {
    ...
    Thread.sleep( 10000 );
    driver.findElement( By.id( "email_create" ) ).sendKeys( "testingTesting123@test.com" );
    Thread.sleep( 1000 );
    //    driver.findElement( new By.ById("email") ).sendKeys( "testing@test.com" );
    ...
    Thread.sleep( 500 );
    driver.findElement( By.cssSelector( "#id_state > option:nth-child(52)" ) ).click();
    Thread.sleep( 500 );
